...
AVAILABLE_THEMES: list[str] = [
    "monokai", "dracula", "nord", "github-dark", "one-dark",
    "solarized-dark", "solarized-light", "gruvbox-dark", "gruvbox-light",
    "fruity", "native", "vim", "vs", "default", "friendly",
    "colorful", "autumn", "rrt", "trac", "tango", "perldoc",
    "rainbow_dash", "lovelace", "inkpot", "zenburn", "paraiso-dark",
    "paraiso-light", "manni", "emacs", "abap",
]
